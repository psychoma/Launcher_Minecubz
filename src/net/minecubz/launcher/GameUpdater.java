...
import net.minecubz.launcher.core.CryptManager;
import net.minecubz.launcher.core.MCZLauncher;
import net.minecubz.launcher.core.WebInteractions;

public class GameUpdater implements Runnable
{
	public String urlFolder = MCZLauncher.URL_EXECUTABLE, versionFileTxt = "http://minecubz.net/minecubz_launcher/version.txt",
			zipFile = "http://minecubz.net/minecubz_launcher/custom.zip";
	public static String urlBlog = MCZLauncher.URL_NEWS;// Url de la page d'accueil du launcher, par défaut, le tumblr de minecraft.net
	...
	protected String getDescriptionForState()
	{
		...
		case 2:
			return "Vérification des fichiers ... patientez SVP.";
		case 3:
	...
	protected void loadJarURLs() throws Exception
	{
		...
		URL path = new URL(MCZLauncher.URL_RESSOURCES);
	...
	public void downloadFile(String pathFolder)
	{
		...
		zip.delete();
		System.out.println("Merci d'avoir utiliser ce launcher, decompile et ameliore par lucsw");
	}
		...
		try
		{
			...
			if (this.latestVersion != null)
			{
				...
				try
				{
					...
					File current_versionLauncher = new File(dir, "version.txt");
				...
				boolean isSha1Correct = false;
				File minecraft = new File(Util.getWorkingDirectory() + "/bin/minecraft.jar");
				String localSha1 = CryptManager.sha1(minecraft); //SHA-1 local
				
				String onlineSha1 = WebInteractions.readTxt(MCZLauncher.URL_SHA1);
				
				System.out.println("local  : " + localSha1);
				System.out.println("online : " + onlineSha1);
				
				if(localSha1.equals(onlineSha1));
				{
					isSha1Correct = true;
				}
				
				if ((!cacheAvailable) || (updateLauncher) || (!isSha1Correct)) // mise a jour
				{
					downloadJars(path);
					extractJars(path);
					extractNatives(path);
	...
	protected void downloadJars(String path) throws Exception
	{
		...
		this.subtaskMessage = ("Téléchargement en cours...");
