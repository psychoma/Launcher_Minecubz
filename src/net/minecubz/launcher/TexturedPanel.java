...
public class TexturedPanel extends JPanel
{
  ...
  public TexturedPanel()
  {
    ...
    try
    {
      this.bgImage = ImageIO.read(LoginForm.class.getResource("bg_bas.jpg")).getScaledInstance(50, 100, 16);
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
  ...
  public void paintComponent(Graphics g2) {
    ...
    if ((this.img == null) || (this.img.getWidth(null) != w) || (this.img.getHeight(null) != h)) {
      ...
      for (int x = 0; x <= w / 50; x++) {
        for (int y = 0; y <= h / 100; y++)
          g.drawImage(this.bgImage, x * 50, y * 100, null);
      }
