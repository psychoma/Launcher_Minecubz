...
public class LoginForm extends TransparentPanel
{
  ...
  private TransparentCheckbox rememberBox = new TransparentCheckbox("Garder le mot de passe");
  private TransparentButton launchButton = new TransparentButton("Jouer");
  private TransparentButton optionsButton = new TransparentButton("Options");
  private TransparentButton retryButton = new TransparentButton("Re-essayer");
  ...
  private void readUsername() {
    try {
      File lastLogin = new File(Util.getWorkingDirectory("minecubz"), "lastlogin");
  ...
  private JScrollPane getUpdateNews()
  {
    ...
    try
    {
      ...
      editorPane.setText("<html><body><font color=\"#808080\"><br><br><br><br><br><br><br><center>Chargement des news ...</center></font></body></html>");
      ...
      new Thread() {
        public void run() {
          try {
            ...
            e.printStackTrace();
            editorPane.setText("<html><body><font color=\"#808080\"><br><br><br><br><br><br><br><center>Impossible de charger les news !<br>" + e.toString() + "</center></font></body></html>");
          }
        }
      }
      .start();
  ...
  private JPanel buildLoginPanel() {
    ...
    titles.add(new TransparentLabel("Compte:", 4));
    ...
    try
    {
      ...
      {
        TransparentLabel accountLink = new TransparentLabel("Acheter Minecraft") {
  ...
  public void setLoggingIn() {
    ...
    southPanel.add(new LogoPanel(), "West");
    southPanel.add(new TransparentPanel(), "Center");
    JLabel label = new TransparentLabel("Chargement...                      ", 0);
